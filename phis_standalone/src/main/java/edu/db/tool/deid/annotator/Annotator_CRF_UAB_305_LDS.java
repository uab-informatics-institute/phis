 ...
 * @author Duy Bui
 */
public class Annotator_CRF_UAB_305_LDS{
    ...
    public static AbstractSequenceClassifier<CoreLabel> getFileClassifier() {
        if (fileClassifier == null) {
            try {
                ...
                InputStream in = ResourceUtil.class.getResourceAsStream("/edu/db/tool/deid/resources/crf/crf.binary.uab.305.model.gz");
